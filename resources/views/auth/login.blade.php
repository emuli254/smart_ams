@extends('layouts/app', ['activePage' => 'login', 'title' => 'ODPP Asset Management System by Muli'])
                            ...
                            <div class="card-body ">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-14">
                                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="admin@lightbp.com" required autocomplete="email" autofocus>
