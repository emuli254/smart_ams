						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									{{Form::label('office_location_id_source', 'Office location')}}
									{{Form::select('office_location_id_source', $locations->pluck('name', 'id'), null, ['id' => 'select2', 'class' => 'form-control select2', 'placeholder' => 'Office location'])}}
								</div>
							</div>
						</div>
				...
				<div class="box box-danger">
					...
					<div class="box-body">
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="form-group">
									{{Form::label('office_location_id_destination', 'Office location')}}
									{{Form::select('office_location_id_destination', $locations->pluck('name', 'id'), null, ['id' => 'select2', 'class' => 'form-control select2', 'placeholder' => 'Office location'])}}
								</div>
							</div>
						</div>
