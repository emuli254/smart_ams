@extends('layouts.app', ['activePage' => 'upgrade', 'title' => 'ODPP Asset Management System by Muli', 'navName' => 'Upgrade', 'activeButton' => 'laravel'])
                        ...
                        <div class="col-md-8 ml-auto mr-auto">
                            <div class="card">
                                <div class="header text-center">
                                    ...
                                    <p class="category">{{ __('Are you looking for more components? Please check our Premium Version of ODPP Asset Management System.')}}</p>
                                    <br>
                                </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="last-row">
                                                ...
                                                <td>
                                                    <a target="_blank" href="https://www.odpp.go.ke/product/light-bootstrap-dashboard-pro-laravel" class="btn btn-round btn-fill btn-info">{{ __('Priority List') }}</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
