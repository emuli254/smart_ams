...
@extends('layouts.app', ['activePage' => 'edit', 'title' => 'Create Order', 'navName' => 'Dashboard', 'activeButton' => 'laravel'])
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
									...
									{{Form::select('staff_id', $staff->pluck('name', 'id'), null, ['id' => 'select2', 'class' => 'form-control select2', 'placeholder' => 'staff'])}}
									<p>Is the staff you're looking for not in this list? Add them <a target="_blank" href="/staff/create">here</a>.</p>
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
