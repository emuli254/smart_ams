...
@extends('layouts.app', ['activePage' => 'edit', 'title' => 'Edit Supplier', 'navName' => 'Dashboard', 'activeButton' => 'laravel'])
			...
			<div class="col-sm-12">
				<div class="box box-danger">
					...
					<div class="box-body">
                        ...
                        {!! Form::model( $supplier, ['route' => ['suppliers.update', $supplier->id], 'method' => 'POST' ]) !!}
