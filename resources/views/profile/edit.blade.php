@extends('layouts.app', ['activePage' => 'user', 'title' => 'ODPP Asset Management System by Muli', 'navName' => 'User Profile', 'activeButton' => 'laravel'])
                            ...
                            <div class="card-body">
                                <div class="author">
                                    <a href="#">
                                        ...
                                        <h5 class="title">{{ __('Erick Muli') }}</h5>
                                    </a>
                                    <p class="description">
                                        {{ __('michael24') }}
                                    </p>
