            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        {{ Form::text('asset_id', '', ['class' => 'form-control', 'placeholder' => 'Asset ID']) }}
                    </div>
                </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  {{Form::select('instock', [0 => 'No', 1 => 'Yes'], null, ['id' => 'select2', 'class' => 'form-control select2', 'placeholder' => 'Please Select One'])}}
                </div>
              </div>
              <div class="col-sm-6">
                <div class="form-group">
